...
const Input = ({ end, size = "md", className = "", ...props }) => {
  ...
  return (
    <input
      className={`${getSize(
        size
      )} ${className} text-base bg-white placeholder:text-[#8692A6] border border-black rounded-[6px] focus:border-green-800 w-[380px]`}
      {...props}
    />
  );
};
